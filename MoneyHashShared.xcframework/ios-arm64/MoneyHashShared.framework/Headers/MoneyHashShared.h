...
- (MHSCommonFlow<MHSDataState<MHSKotlinUnit *> *> *)deleteSavedCardCardTokenId:(NSString *)cardTokenId intentSecret:(NSString *)intentSecret __attribute__((swift_name("deleteSavedCard(cardTokenId:intentSecret:)")));
...
*/
- (void)deleteSavedCardCardTokenId:(NSString *)cardTokenId secret:(NSString *)secret completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("deleteSavedCard(cardTokenId:secret:completionHandler:)")));
