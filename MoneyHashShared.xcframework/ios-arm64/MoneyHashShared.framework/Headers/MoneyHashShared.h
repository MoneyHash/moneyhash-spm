...
@property (class, readonly, getter=shared) MHSPaymentStateFailed *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PaymentState.RequireExtraAction")))
@interface MHSPaymentStateRequireExtraAction : MHSPaymentState
- (instancetype)initWithActions:(NSArray<NSString *> *)actions __attribute__((swift_name("init(actions:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
@property (class, readonly, getter=shared) MHSPaymentStateSuccess *shared __attribute__((swift_name("shared")));
@end;
...
- (instancetype)initWithActiveTransaction:(MHSActiveTransaction * _Nullable)activeTransaction __attribute__((swift_name("init(activeTransaction:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MHSActionDataCompanion *companion __attribute__((swift_name("companion")));
- (MHSActiveTransaction * _Nullable)component1 __attribute__((swift_name("component1()")));
- (MHSActionData *)doCopyActiveTransaction:(MHSActiveTransaction * _Nullable)activeTransaction __attribute__((swift_name("doCopy(activeTransaction:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MHSActiveTransaction * _Nullable activeTransaction __attribute__((swift_name("activeTransaction")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ActiveTransaction.Companion")))
@interface MHSActiveTransactionCompanion : MHSBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MHSActiveTransactionCompanion *shared __attribute__((swift_name("shared")));
- (id<MHSKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;
...
- (instancetype)initWithNext:(NSString * _Nullable)next data:(MHSData * _Nullable)data previous:(NSString * _Nullable)previous count:(MHSInt * _Nullable)count status:(MHSStatus * _Nullable)status __attribute__((swift_name("init(next:data:previous:count:status:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MHSPaymentInformationCompanion *companion __attribute__((swift_name("companion")));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (MHSData * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (MHSInt * _Nullable)component4 __attribute__((swift_name("component4()")));
- (MHSStatus * _Nullable)component5 __attribute__((swift_name("component5()")));
- (MHSPaymentInformation *)doCopyNext:(NSString * _Nullable)next data:(MHSData * _Nullable)data previous:(NSString * _Nullable)previous count:(MHSInt * _Nullable)count status:(MHSStatus * _Nullable)status __attribute__((swift_name("doCopy(next:data:previous:count:status:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
