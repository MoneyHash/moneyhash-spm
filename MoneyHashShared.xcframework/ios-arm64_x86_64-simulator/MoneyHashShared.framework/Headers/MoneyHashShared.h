...
+ (void)Skie_Suspend__47__deleteSavedCardDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver cardTokenId:(NSString *)cardTokenId intentSecret:(NSString *)intentSecret suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__deleteSavedCard(dispatchReceiver:cardTokenId:intentSecret:suspendHandler:)")));
+ (void)Skie_Suspend__48__getApplePayBinLookupDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver receipt:(NSString *)receipt receiptBillingData:(NSDictionary<NSString *, NSString *> * _Nullable)receiptBillingData methodID:(NSString *)methodID flowId:(NSString * _Nullable)flowId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__48__getApplePayBinLookup(dispatchReceiver:receipt:receiptBillingData:methodID:flowId:suspendHandler:)")));
+ (void)Skie_Suspend__49__getCardInformationDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver cardIntentId:(NSString *)cardIntentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__49__getCardInformation(dispatchReceiver:cardIntentId:suspendHandler:)")));
...
+ (void)Skie_Suspend__50__getInstallmentPlansDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver amount:(MHSDouble * _Nullable)amount currency:(NSString *)currency first6Digits:(NSString * _Nullable)first6Digits suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__getInstallmentPlans(dispatchReceiver:amount:currency:first6Digits:suspendHandler:)")));
+ (void)Skie_Suspend__51__getMethodsDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver paymentIntentId:(NSString *)paymentIntentId type:(MHSType *)type suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__getMethods(dispatchReceiver:paymentIntentId:type:suspendHandler:)")));
+ (void)Skie_Suspend__52__getMethodsDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver currency:(NSString *)currency amount:(MHSDouble * _Nullable)amount customer:(NSString * _Nullable)customer flowId:(NSString * _Nullable)flowId operation:(MHSIntentOperation * _Nullable)operation customFields:(NSDictionary<NSString *, MHSCustomFieldValue *> * _Nullable)customFields suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__getMethods(dispatchReceiver:currency:amount:customer:flowId:operation:customFields:suspendHandler:)")));
+ (void)Skie_Suspend__53__getPaymentInformationDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver paymentId:(NSString *)paymentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__getPaymentInformation(dispatchReceiver:paymentId:suspendHandler:)")));
+ (void)Skie_Suspend__54__getPayoutInformationDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver payoutId:(NSString *)payoutId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__getPayoutInformation(dispatchReceiver:payoutId:suspendHandler:)")));
+ (void)Skie_Suspend__55__getSubscriptionPlanGroupsDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver limit:(MHSInt * _Nullable)limit offset:(MHSInt * _Nullable)offset currency:(NSString * _Nullable)currency suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__getSubscriptionPlanGroups(dispatchReceiver:limit:offset:currency:suspendHandler:)")));
+ (void)Skie_Suspend__56__getSubscriptionPlansDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver planGroupId:(NSString *)planGroupId customerId:(NSString *)customerId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__getSubscriptionPlans(dispatchReceiver:planGroupId:customerId:suspendHandler:)")));
+ (void)Skie_Suspend__57__proceedWithPaymentMethodDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId selectedMethodId:(NSString *)selectedMethodId methodType:(MHSMethodType *)methodType metaData:(MHSMethodMetaData * _Nullable)metaData useWalletBalance:(MHSBoolean * _Nullable)useWalletBalance installmentPlanData:(MHSInstallmentPlanData * _Nullable)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__57__proceedWithPaymentMethod(dispatchReceiver:intentId:selectedMethodId:methodType:metaData:useWalletBalance:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__58__proceedWithPayoutMethodDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId selectedMethodId:(NSString *)selectedMethodId methodType:(MHSMethodType *)methodType metaData:(MHSMethodMetaData * _Nullable)metaData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__58__proceedWithPayoutMethod(dispatchReceiver:intentId:selectedMethodId:methodType:metaData:suspendHandler:)")));
+ (void)Skie_Suspend__59__resetPaymentSelectedMethodDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__59__resetPaymentSelectedMethod(dispatchReceiver:intentId:suspendHandler:)")));
...
+ (void)Skie_Suspend__60__resetPayoutSelectedMethodDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__60__resetPayoutSelectedMethod(dispatchReceiver:intentId:suspendHandler:)")));
+ (void)Skie_Suspend__61__selectInstallmentPlanDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId installmentPlanData:(MHSInstallmentPlanData *)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__61__selectInstallmentPlan(dispatchReceiver:intentId:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__62__selectSubscriptionPlanDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver planGroupId:(NSString *)planGroupId customerId:(NSString *)customerId planId:(NSString *)planId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__62__selectSubscriptionPlan(dispatchReceiver:planGroupId:customerId:planId:suspendHandler:)")));
+ (void)Skie_Suspend__63__submitCardCVVDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId cvv:(NSString *)cvv installmentPlanData:(MHSInstallmentPlanData * _Nullable)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__63__submitCardCVV(dispatchReceiver:intentId:cvv:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__64__submitFormDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver paymentIntentId:(NSString *)paymentIntentId method:(NSString *)method billingFields:(NSDictionary<NSString *, NSString *> * _Nullable)billingFields shippingFields:(NSDictionary<NSString *, NSString *> * _Nullable)shippingFields vaultData:(MHSVaultData * _Nullable)vaultData saveCard:(MHSBoolean * _Nullable)saveCard installmentPlanData:(MHSInstallmentPlanData * _Nullable)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__64__submitForm(dispatchReceiver:paymentIntentId:method:billingFields:shippingFields:vaultData:saveCard:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__65__submitPaymentReceiptDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver paymentIntentId:(NSString *)paymentIntentId receipt:(NSString *)receipt receiptBillingData:(NSDictionary<NSString *, NSString *> * _Nullable)receiptBillingData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__65__submitPaymentReceipt(dispatchReceiver:paymentIntentId:receipt:receiptBillingData:suspendHandler:)")));
+ (void)Skie_Suspend__66__tokenizeReceiptDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver receipt:(NSString *)receipt methodId:(NSString *)methodId cardTokenIntentId:(NSString *)cardTokenIntentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__66__tokenizeReceipt(dispatchReceiver:receipt:methodId:cardTokenIntentId:suspendHandler:)")));
+ (void)Skie_Suspend__67__updateDiscountDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId discount:(MHSDiscountItem *)discount suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__67__updateDiscount(dispatchReceiver:intentId:discount:suspendHandler:)")));
+ (void)Skie_Suspend__68__updateFeesDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId fees:(NSArray<MHSFeeItem *> *)fees suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__68__updateFees(dispatchReceiver:intentId:fees:suspendHandler:)")));
+ (void)Skie_Suspend__69__binLookupDispatchReceiver:(MHSCardCollector *)dispatchReceiver cardData:(MHSVaultData *)cardData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__69__binLookup(dispatchReceiver:cardData:suspendHandler:)")));
...
+ (void)Skie_Suspend__70__binLookupDispatchReceiver:(MHSCardCollector *)dispatchReceiver suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__70__binLookup(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__71__collectDispatchReceiver:(MHSCardCollector *)dispatchReceiver token:(NSString * _Nullable)token suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__71__collect(dispatchReceiver:token:suspendHandler:)")));
+ (void)Skie_Suspend__72__createCardTokenDispatchReceiver:(MHSCardCollector *)dispatchReceiver cardIntentId:(NSString *)cardIntentId cardData:(MHSVaultData *)cardData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__72__createCardToken(dispatchReceiver:cardIntentId:cardData:suspendHandler:)")));
+ (void)Skie_Suspend__73__payDispatchReceiver:(MHSCardCollector *)dispatchReceiver intentId:(NSString *)intentId cardData:(MHSVaultData *)cardData saveCard:(BOOL)saveCard billingFields:(NSDictionary<NSString *, NSString *> * _Nullable)billingFields shippingFields:(NSDictionary<NSString *, NSString *> * _Nullable)shippingFields installmentPlanData:(MHSInstallmentPlanData * _Nullable)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__73__pay(dispatchReceiver:intentId:cardData:saveCard:billingFields:shippingFields:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__74__getDemoIntentsDispatchReceiver:(MHSSandboxUseCase *)dispatchReceiver accessToken:(NSString *)accessToken suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__74__getDemoIntents(dispatchReceiver:accessToken:suspendHandler:)")));
...
+ (void)Skie_Suspend__76__upgradeDispatchReceiver:(MHSKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<MHSKtor_ioByteReadChannel>)input output:(id<MHSKtor_ioByteWriteChannel>)output engineContext:(id<MHSKotlinCoroutineContext>)engineContext userContext:(id<MHSKotlinCoroutineContext>)userContext suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__76__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__77__flushDispatchReceiver:(id<MHSKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__77__flush(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__78__flushAndCloseDispatchReceiver:(id<MHSKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__78__flushAndClose(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__79__writeToDispatchReceiver:(MHSKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<MHSKtor_ioByteWriteChannel>)channel suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__79__writeTo(dispatchReceiver:channel:suspendHandler:)")));
...
+ (void)Skie_Suspend__80__handleNetworkExceptionExtensionReceiver:(MHSKotlinThrowable *)extensionReceiver suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__80__handleNetworkException(extensionReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__81__handleResponseValidationExtensionReceiver:(MHSKtor_client_coreHttpCallValidatorConfig *)extensionReceiver response:(MHSKtor_client_coreHttpResponse *)response suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__81__handleResponseValidation(extensionReceiver:response:suspendHandler:)")));
