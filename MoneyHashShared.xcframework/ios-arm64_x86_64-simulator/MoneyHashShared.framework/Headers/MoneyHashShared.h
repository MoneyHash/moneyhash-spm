...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureFlagData")))
@interface MHSFeatureFlagData : MHSBase <MHSCommonParcelable>
@property (class, readonly, getter=companion) MHSFeatureFlagDataCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) MHSFeatureFlagState * _Nullable data __attribute__((swift_name("data")));
@property (readonly) MHSStatus * _Nullable status __attribute__((swift_name("status")));
- (instancetype)initWithData:(MHSFeatureFlagState * _Nullable)data status:(MHSStatus * _Nullable)status __attribute__((swift_name("init(data:status:)"))) __attribute__((objc_designated_initializer));
- (MHSFeatureFlagData *)doCopyData:(MHSFeatureFlagState * _Nullable)data status:(MHSStatus * _Nullable)status __attribute__((swift_name("doCopy(data:status:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureFlagData.Companion")))
@interface MHSFeatureFlagDataCompanion : MHSBase
@property (class, readonly, getter=shared) MHSFeatureFlagDataCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<MHSKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureFlagState")))
@interface MHSFeatureFlagState : MHSBase <MHSCommonParcelable>
@property (class, readonly, getter=companion) MHSFeatureFlagStateCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) BOOL enabled __attribute__((swift_name("enabled")));
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
- (instancetype)initWithName:(NSString * _Nullable)name enabled:(BOOL)enabled __attribute__((swift_name("init(name:enabled:)"))) __attribute__((objc_designated_initializer));
- (MHSFeatureFlagState *)doCopyName:(NSString * _Nullable)name enabled:(BOOL)enabled __attribute__((swift_name("doCopy(name:enabled:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureFlagState.Companion")))
@interface MHSFeatureFlagStateCompanion : MHSBase
@property (class, readonly, getter=shared) MHSFeatureFlagStateCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<MHSKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((swift_name("FeatureFlagService")))
@protocol MHSFeatureFlagService
@required

/**
 * @note This method converts all Kotlin exceptions to errors.
*/
- (void)getFeatureFlagFeatureName:(NSString *)featureName completionHandler:(void (^)(MHSFeatureFlagData * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getFeatureFlag(featureName:completionHandler:)")));
@end
...
@property (readonly) id<MHSFeatureFlagService> featureFlagService __attribute__((swift_name("featureFlagService")));
...
@property (readonly) MHSFeatureFlagUseCase *featureFlag __attribute__((swift_name("featureFlag")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureFlagUseCase")))
@interface MHSFeatureFlagUseCase : MHSBase
- (instancetype)initWithFeatureFlagService:(id<MHSFeatureFlagService>)featureFlagService __attribute__((swift_name("init(featureFlagService:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)isEnabledFlag:(MHSFeatureFlag *)flag completionHandler:(void (^)(MHSBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("isEnabled(flag:completionHandler:)")));
@end
...
@property (readonly) NSString *FEATURES_END_POINT __attribute__((swift_name("FEATURES_END_POINT")));
@property (readonly) NSString *FEATURE_FLAG_FETCH_INTENT_BEFORE_THROWING_USER_CANCEL __attribute__((swift_name("FEATURE_FLAG_FETCH_INTENT_BEFORE_THROWING_USER_CANCEL")));
...
@interface MHSFeatureFlag : MHSKotlinEnum<MHSFeatureFlag *>
@property (class, readonly, getter=companion) MHSFeatureFlagCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) MHSFeatureFlag *fetchIntentBeforeThrowingUserCancel __attribute__((swift_name("fetchIntentBeforeThrowingUserCancel")));
@property (class, readonly) NSArray<MHSFeatureFlag *> *entries __attribute__((swift_name("entries")));
@property (readonly) NSString *key __attribute__((swift_name("key")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (MHSKotlinArray<MHSFeatureFlag *> *)values __attribute__((swift_name("values()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureFlag.Companion")))
@interface MHSFeatureFlagCompanion : MHSBase
@property (class, readonly, getter=shared) MHSFeatureFlagCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (MHSFeatureFlag * _Nullable)fromKey:(NSString *)key __attribute__((swift_name("from(key:)")));
@end
...
+ (void)Skie_Suspend__39__tokenizeReceiptDispatchReceiver:(id<MHSPaymentService>)dispatchReceiver receipt:(NSString *)receipt methodId:(NSString *)methodId cardTokenIntentId:(NSString *)cardTokenIntentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__39__tokenizeReceipt(dispatchReceiver:receipt:methodId:cardTokenIntentId:suspendHandler:)")));
...
+ (void)Skie_Suspend__42__useBankAccountTokenDispatchReceiver:(id<MHSPaymentService>)dispatchReceiver paymentIntentId:(NSString *)paymentIntentId bankAccountTokenId:(NSString *)bankAccountTokenId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__42__useBankAccountToken(dispatchReceiver:paymentIntentId:bankAccountTokenId:suspendHandler:)")));
+ (void)Skie_Suspend__43__usePaymentMethodDispatchReceiver:(id<MHSPaymentService>)dispatchReceiver intentId:(NSString *)intentId methodName:(NSString *)methodName useWalletBalance:(MHSBoolean * _Nullable)useWalletBalance installmentPlanData:(MHSInstallmentPlanData * _Nullable)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__43__usePaymentMethod(dispatchReceiver:intentId:methodName:useWalletBalance:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__44__usePayoutMethodDispatchReceiver:(id<MHSPaymentService>)dispatchReceiver intentId:(NSString *)intentId methodName:(NSString *)methodName suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__44__usePayoutMethod(dispatchReceiver:intentId:methodName:suspendHandler:)")));
+ (void)Skie_Suspend__45__useSavedCardDispatchReceiver:(id<MHSPaymentService>)dispatchReceiver paymentIntentId:(NSString *)paymentIntentId cardTokenId:(NSString *)cardTokenId cvv:(NSString * _Nullable)cvv useWalletBalance:(MHSBoolean * _Nullable)useWalletBalance installmentPlanData:(MHSInstallmentPlanData * _Nullable)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__45__useSavedCard(dispatchReceiver:paymentIntentId:cardTokenId:cvv:useWalletBalance:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__46__useSelfWalletDispatchReceiver:(id<MHSPaymentService>)dispatchReceiver paymentIntentId:(NSString *)paymentIntentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__46__useSelfWallet(dispatchReceiver:paymentIntentId:suspendHandler:)")));
+ (void)Skie_Suspend__47__getFeatureFlagDispatchReceiver:(id<MHSFeatureFlagService>)dispatchReceiver featureName:(NSString *)featureName suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__getFeatureFlag(dispatchReceiver:featureName:suspendHandler:)")));
...
+ (void)Skie_Suspend__50__getCardInformationDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver cardIntentId:(NSString *)cardIntentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__getCardInformation(dispatchReceiver:cardIntentId:suspendHandler:)")));
+ (void)Skie_Suspend__51__getInstallmentPlansDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver amount:(MHSDouble * _Nullable)amount currency:(NSString *)currency first6Digits:(NSString * _Nullable)first6Digits suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__getInstallmentPlans(dispatchReceiver:amount:currency:first6Digits:suspendHandler:)")));
+ (void)Skie_Suspend__52__getMethodsDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver paymentIntentId:(NSString *)paymentIntentId type:(MHSType *)type suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__getMethods(dispatchReceiver:paymentIntentId:type:suspendHandler:)")));
+ (void)Skie_Suspend__53__getMethodsDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver currency:(NSString *)currency amount:(MHSDouble * _Nullable)amount customer:(NSString * _Nullable)customer flowId:(NSString * _Nullable)flowId operation:(MHSIntentOperation * _Nullable)operation customFields:(NSDictionary<NSString *, MHSCustomFieldValue *> * _Nullable)customFields suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__getMethods(dispatchReceiver:currency:amount:customer:flowId:operation:customFields:suspendHandler:)")));
+ (void)Skie_Suspend__54__getPaymentInformationDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver paymentId:(NSString *)paymentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__getPaymentInformation(dispatchReceiver:paymentId:suspendHandler:)")));
+ (void)Skie_Suspend__55__getPayoutInformationDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver payoutId:(NSString *)payoutId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__getPayoutInformation(dispatchReceiver:payoutId:suspendHandler:)")));
+ (void)Skie_Suspend__56__getSubscriptionPlanGroupsDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver limit:(MHSInt * _Nullable)limit offset:(MHSInt * _Nullable)offset currency:(NSString * _Nullable)currency suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__getSubscriptionPlanGroups(dispatchReceiver:limit:offset:currency:suspendHandler:)")));
+ (void)Skie_Suspend__57__getSubscriptionPlansDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver planGroupId:(NSString *)planGroupId customerId:(NSString *)customerId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__57__getSubscriptionPlans(dispatchReceiver:planGroupId:customerId:suspendHandler:)")));
+ (void)Skie_Suspend__58__proceedWithPaymentMethodDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId selectedMethodId:(NSString *)selectedMethodId methodType:(MHSMethodType *)methodType metaData:(MHSMethodMetaData * _Nullable)metaData useWalletBalance:(MHSBoolean * _Nullable)useWalletBalance installmentPlanData:(MHSInstallmentPlanData * _Nullable)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__58__proceedWithPaymentMethod(dispatchReceiver:intentId:selectedMethodId:methodType:metaData:useWalletBalance:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__59__proceedWithPayoutMethodDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId selectedMethodId:(NSString *)selectedMethodId methodType:(MHSMethodType *)methodType metaData:(MHSMethodMetaData * _Nullable)metaData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__59__proceedWithPayoutMethod(dispatchReceiver:intentId:selectedMethodId:methodType:metaData:suspendHandler:)")));
...
+ (void)Skie_Suspend__60__resetPaymentSelectedMethodDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__60__resetPaymentSelectedMethod(dispatchReceiver:intentId:suspendHandler:)")));
+ (void)Skie_Suspend__61__resetPayoutSelectedMethodDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__61__resetPayoutSelectedMethod(dispatchReceiver:intentId:suspendHandler:)")));
+ (void)Skie_Suspend__62__selectInstallmentPlanDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId installmentPlanData:(MHSInstallmentPlanData *)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__62__selectInstallmentPlan(dispatchReceiver:intentId:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__63__selectSubscriptionPlanDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver planGroupId:(NSString *)planGroupId customerId:(NSString *)customerId planId:(NSString *)planId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__63__selectSubscriptionPlan(dispatchReceiver:planGroupId:customerId:planId:suspendHandler:)")));
+ (void)Skie_Suspend__64__submitCardCVVDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId cvv:(NSString *)cvv installmentPlanData:(MHSInstallmentPlanData * _Nullable)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__64__submitCardCVV(dispatchReceiver:intentId:cvv:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__65__submitFormDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver paymentIntentId:(NSString *)paymentIntentId method:(NSString *)method billingFields:(NSDictionary<NSString *, NSString *> * _Nullable)billingFields shippingFields:(NSDictionary<NSString *, NSString *> * _Nullable)shippingFields vaultData:(MHSVaultData * _Nullable)vaultData saveCard:(MHSBoolean * _Nullable)saveCard installmentPlanData:(MHSInstallmentPlanData * _Nullable)installmentPlanData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__65__submitForm(dispatchReceiver:paymentIntentId:method:billingFields:shippingFields:vaultData:saveCard:installmentPlanData:suspendHandler:)")));
+ (void)Skie_Suspend__66__submitPaymentReceiptDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver paymentIntentId:(NSString *)paymentIntentId receipt:(NSString *)receipt receiptBillingData:(NSDictionary<NSString *, NSString *> * _Nullable)receiptBillingData suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__66__submitPaymentReceipt(dispatchReceiver:paymentIntentId:receipt:receiptBillingData:suspendHandler:)")));
+ (void)Skie_Suspend__67__tokenizeReceiptDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver receipt:(NSString *)receipt methodId:(NSString *)methodId cardTokenIntentId:(NSString *)cardTokenIntentId suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__67__tokenizeReceipt(dispatchReceiver:receipt:methodId:cardTokenIntentId:suspendHandler:)")));
+ (void)Skie_Suspend__68__updateDiscountDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId discount:(MHSDiscountItem *)discount suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__68__updateDiscount(dispatchReceiver:intentId:discount:suspendHandler:)")));
+ (void)Skie_Suspend__69__updateFeesDispatchReceiver:(MHSPaymentUseCase *)dispatchReceiver intentId:(NSString *)intentId fees:(NSArray<MHSFeeItem *> *)fees suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__69__updateFees(dispatchReceiver:intentId:fees:suspendHandler:)")));
...
+ (void)Skie_Suspend__70__isEnabledDispatchReceiver:(MHSFeatureFlagUseCase *)dispatchReceiver flag:(MHSFeatureFlag *)flag suspendHandler:(MHSSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__70__isEnabled(dispatchReceiver:flag:suspendHandler:)")));
